...
public class JackTokenizer {
    ...
    //Initializes keyWordMAp and opSet
    static {
    ...
    /**
     * Initializes Regex for tokenizer
     */
    ...
    /**
     * Checks if the there is more token
     * @return
     */
    ...
    /**
     * Returns the keyword if the current token type is KEYWORD
     * @return
     */
    public int keyWord(){
    ...
    /**
     * Returns the character if the current token type is SYMBOL
    ...
    /**
     * Returns the identifier if the current token type is IDENTIFIER
     * @return
     */
    ...
    /**
     * Returns the integer value if the current token type is INT_CONST
     * @return
     */
    public int intVal(){
    ...
    /**
     * Returns the string value if the current token is STRING_CONST
     * @return
     */
    ...
    /**
     * Returns if current symbol is an operator
     * @return
     */
    public boolean isOp(){
